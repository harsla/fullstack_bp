 ...
 * bpApp.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://bpApp.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://bpApp.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * ```
 *  angular.module('bpApp', []).config(function($sceDelegateProvider) {
 ...
 *      'http://bpApp.example.com/clickThru**'
 *    ]);
 *  });
 * ```
 */
 ...
 *
 * ```
 * angular.module('bpAppWithSceDisabledbpApp', []).config(function($sceProvider) {
