 ...
 *
 * ```js
 *   bpAppDev = angular.module('bpAppDev', ['bpApp', 'ngMockE2E']);
 *   bpAppDev.run(function($httpBackend) {
...
if(window.jasmine || window.mocha) {
   ...
   * ```js
   *
   *   angular.module('bpApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('bpApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('bpApplicationModule'));
   *
   *
